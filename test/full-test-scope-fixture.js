...
export async function createFullTestScopeFixture(t,{failingFullSuite=false,dependencyFixture=false,fullSuiteTestSource}={}){
  const base=await createExecutionScopeFixture(t,{byteIdenticalReplacements:true,sevenFocusedTests:true,fullSuite:true,failingFullSuite,dependencyFixture,fullSuiteTestSource});
