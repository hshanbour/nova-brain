...
import {createGithubWriteAttestation,LIVE_PUSH_ATTESTATION} from "../src/autonomy/github-write-attestation.js";
...
test("remote branch mismatch is rejected",()=>rejects({},"remote_sha_mismatch",{remoteSha:"b".repeat(40)}));
