...
const voiceClient=createVoiceV2Client({getFamiliarityConsent:()=>speakerFamiliarity.getConsentToken()});const playback=createAudioPlayback({Audio:window.Audio,URL});
