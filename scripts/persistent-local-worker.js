...
await runPersistentWorkerService({baseUrl:base,repositoryRoot,intervalMs:interval,version:process.env.NOVA_WORKER_VERSION||"local",probeOnly,maxIterations:probeOnly?3:Infinity,shouldStop:()=>stopping});
