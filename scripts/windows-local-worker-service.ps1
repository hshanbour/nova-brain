...
$arguments='"'+$script+'" --preview-url "'+$PreviewUrl.TrimEnd('/')+'" --git-executable "'+$git+'"'; $taskAction=New-ScheduledTaskAction -Execute $node -Argument $arguments -WorkingDirectory $root
