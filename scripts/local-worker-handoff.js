...
const credentials=await loadLocalWorkerCredentials();
...
const {request}=createLocalWorkerClient({baseUrl:base,novaToken:credentials.novaToken,vercelBypassToken:credentials.vercelBypassToken});
try{for(let count=0;count<12;count+=1){
