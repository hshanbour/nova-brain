...
async function recoverBoundRemediation(options,state,descriptor){
  ...
  const implementationContentReplan=[IMPLEMENTATION_CONTENT_DESCRIPTOR,SOURCE_LITERAL_DESCRIPTOR,OBSERVABLE_LINKAGE_DESCRIPTOR,SEMANTIC_EVIDENCE_DESCRIPTOR,FAILED_SEMANTIC_READ_DESCRIPTOR].includes(descriptor),sourceLiteralReplan=[SOURCE_LITERAL_DESCRIPTOR,OBSERVABLE_LINKAGE_DESCRIPTOR,SEMANTIC_EVIDENCE_DESCRIPTOR,FAILED_SEMANTIC_READ_DESCRIPTOR].includes(descriptor),observableLinkageReplan=[OBSERVABLE_LINKAGE_DESCRIPTOR,SEMANTIC_EVIDENCE_DESCRIPTOR,FAILED_SEMANTIC_READ_DESCRIPTOR].includes(descriptor),semanticEvidenceReplan=[SEMANTIC_EVIDENCE_DESCRIPTOR,FAILED_SEMANTIC_READ_DESCRIPTOR].includes(descriptor),nextSteps=remediationSteps({taskId:task.id,fromStateVersion:task.stateVersion,repository:approvalArguments.repository,branch:task.branch,currentCommit:task.currentCommit,workspaceRoot:approvalArguments.workspaceRoot,runtimeVersion:options.runtimeVersion,sourcePlanStepId:predecessor.sourcePlanStepId,sourceApplyStepId:sourceApply.stepId,sourceApplyFingerprint:sourceApply.operationFingerprint,activeContinuation,requiredPaths,beforeEntries:entries,reviewHash,review,implementationContentReplan,sourceLiteralReplan,observableLinkageReplan,semanticEvidenceReplan});
