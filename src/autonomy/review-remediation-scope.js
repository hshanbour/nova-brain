...
const REMEDIATION_DESCRIPTORS=Object.freeze([SOURCE_LITERAL_DESCRIPTOR,IMPLEMENTATION_CONTENT_DESCRIPTOR,EVIDENCE_BOUND_DESCRIPTOR,SOURCE_BOUND_DESCRIPTOR,REJECTED_DESCRIPTOR,DESCRIPTOR]);
const predecessorDescriptor=descriptor=>descriptor===SOURCE_LITERAL_DESCRIPTOR?IMPLEMENTATION_CONTENT_DESCRIPTOR:descriptor===IMPLEMENTATION_CONTENT_DESCRIPTOR?EVIDENCE_BOUND_DESCRIPTOR:descriptor===EVIDENCE_BOUND_DESCRIPTOR?SOURCE_BOUND_DESCRIPTOR:descriptor===SOURCE_BOUND_DESCRIPTOR?REJECTED_DESCRIPTOR:DESCRIPTOR;
...
async function describeRejectedRemediation(options,descriptor,sourceDescriptor){
  ...
  let privateEvidence;
  if(sourceDescriptor===EVIDENCE_BOUND_DESCRIPTOR||sourceDescriptor===IMPLEMENTATION_CONTENT_DESCRIPTOR){
